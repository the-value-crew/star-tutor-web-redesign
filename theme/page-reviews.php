        ...
        <div class="relative">
            ...
            <div
                ...
                <?php
							...
							$review_of = [];
							$review_of = ["all" => "All Reviews", ...acf_get_field("review_of")["choices"]];
            ...
            <?php
						while($wp_query->have_posts()) {
							if($wp_query->have_posts()) {
								$wp_query->the_post();
								$thestartutor_reviews["all"] = [...$thestartutor_reviews["all"], [ "title" => get_the_title(), ...get_fields() ]];
								$thestartutor_reviews[get_field("review_of")] = [...$thestartutor_reviews[get_field("review_of")], [ "title" => get_the_title(), ...get_fields() ]];
							}
						}
            ...
            <div id="reviews-post-<?php echo $key; ?>"
                ...
                <div id="review-content-<?php echo $key . '-' . $key_index; ?>"
                    ...
                    <div class="flex flex-col gap-2">
                        <div class="self-stretch font-normal leading-relaxed text-normal text-secondary">
                            <div class="line-clamp-6 review-content-body font-normal text-normal">
                                <?php echo $val["review"]; ?>
                            </div>
                            <button class="review-content-toggler font-bold" data-status="less"
