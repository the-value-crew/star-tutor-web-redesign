...
$gmat_club_img = thestartutor_get_static_img("medias/gmatClub.png");
$yelp_img = thestartutor_get_static_img("medias/yelp.png");
    ...
    <main>
      <div class="mt-[100px] xl:mt-[116.3px] 2xl:mt-[122px] px-[16px] md:px-[80px] lg:px-[40px] xl:px-[200px] 2xl:px-[418px]">
        <div class="relative">
          ...
          <div
            class="mt-[40px] flex gap-[40px] justify-start border-b border-surf border-solid border-grey-200"
          >
            <a
              href="#"
          ...
          <div>
            ...
            <div class="mt-[96px] 2xl:mt-[37.5px] flex flex-col gap-[20px] w-[full]">
              ...
              <div class="flex gap-[18px]">
                ...
                >
                  <img src="<?php echo $google_reviews_img; ?>" />
                </div>
                <div
                  class="w-[164px] p-10 flex justify-center items-center rounded-xl border border-solid border-grey-200"
                >
                  <img src="<?php echo $yelp_img; ?>" />
                </div>
                <div
                  class="w-[164px] p-10 flex justify-center items-center rounded-xl border border-solid border-grey-200"
                >
                ...
                >
                  <img
                    src="<?php echo $gmat_club_img; ?>"
                    class="w-[135px] h-[67px]"
                  />
                </div>
              </div>
