  ...
  <body <?php body_class(); ?>>
    ...
    <header class="w-full sticky top-0 z-[100] bg-[#121212] p-[16px] md:px-[80px] lg:px-[40px] xl:px-[200px] 2xl:px-[418px]">
      <nav class="2xl:max-w-[1084px] 2xl:container relative lg:flex lg:justify-center lg:items-center">
        ...
        <div id="navMenu" class="w-full flex-grow-1 max-h-0 overflow-hidden lg:max-h-[500px] lg:overflow-auto transition-all ease-in-out duration-500 bg-[#121212] lg:flex lg:items-center text-secondary-dark">
          <?php
            wp_nav_menu(
              array(
