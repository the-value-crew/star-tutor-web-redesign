...
<div class="container flex items-center justify-center w-full m-auto">
    <div class="2xl:w-[1084px] xl:w-[1040px] lg:w-[942px] md:w-[597px] w-[327px]">
        <section class="2xl:mb-[320px] xl:mb-[200px] lg:mb-[140px] md:mb-[120px] mb-[80px]">
            <section id="reviewsSection" class="flex flex-col md:gap-[60px] gap-[40px] md:items-center">
                <section class="inline-flex flex-col gap-4 md:items-center" id="reviewsText">
                    <div class="relative flex flex-col gap-2 md:items-center" id="reviewText">
                        <svg xmlns="http://www.w3.org/2000/svg" width="172" height="151" viewBox="0 0 172 151"
                            fill="none" class="absolute top-[-110px] left-[85px] hidden xl:block">
                            <g clip-path="url(#clip0_505_3370)">
                                ...
                                <path
                                    ...
                                    fill="#7A7A7A" />
                                <path d="M162.862 101.971L162.271 82.6806L145.834 92.7655L162.862 101.971Z"
                                    fill="#7A7A7A" />
                            </g>
                            <defs>
  ...
  <?php endif; ?> -->
                                ...
                                <p class="leading-relaxed text-heading3 font-heading3 text-primary">
                                    ...
                                    <span class="text-captionBig font-captionBig text-secondary">(<?php
