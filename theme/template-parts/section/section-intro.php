    ...
    <div class="container flex items-center justify-center w-full m-auto">
      ...
      >
        ...
        >
          ...
          <div
            class="md:w-[600px] w-full flex flex-col gap-[20px] md:text-center lg:text-left"
            id="introRight"
          >
            <div
            ...
            >
              <h2
                class="uppercase text-tertiary font-subheading text-subheading"
              >
              ...
              >
                <g clip-path="url(#clip0_950_8725)">
                  ...
                  />
                  <path
                    d="M4.14545 53.355L15.981 70.1376L24.6318 51.6567L4.14545 53.355Z"
                    fill="#7A7A7A"
                  />
                </g>
                <defs>
            ...
            <h3
              class="hidden font-normal text-secondary text-heading3 xl:block"
              id="introQuestion"
            >
            ...
            <?php echo get_field("intro_content", 13); ?>
              ...
              <p
                class="font-semibold text-secondary text-normal md:text-cemter"
              >
