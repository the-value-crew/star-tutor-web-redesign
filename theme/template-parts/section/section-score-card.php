...
<div class="relative">
                ...
                <div class="swiper-slide">
                    <div
                        ...
                        <img src="<?php echo get_field("scores"); ?>"
                            class="object-scale-down w-full h-full rounded-2xl" />
                    </div>
                </div>
                <div class="swiper-slide">
                    <div
    ...
    <!-- without using Swiper for animation-->
    ...
    <!-- <div id="scoreCardSection"
        ...
        <div class="isActiveImageLeft" id="scoreCardDup">
            <div
                class="bg-cover xl:h-[621px] lg:h-[546px] sm: 2xl:w-[1084px] xl:w-[1040px] lg:w-[942px] md:w-[597px] md:h-[347px] w-[327px] overflow-hidden">
        ...
        <div class="isActiveImageRight" id="scoresCard">
            ...
            <div
                class=" xl:h-[621px] lg:h-[546px] 2xl:w-[1084px] xl:w-[1040px] lg:w-[942px] md:w-[597px] md:h-[347px] w-[327px] overflow-hidden">
                <img src="<?php echo get_field("scores"); ?>" class="object-scale-down w-full h-full rounded-2xl" />
            </div>
        </div>
        ...
        <div id="scoresCard3" class="inactive">
            <div style="background-image: url('<?php echo get_field("score_card"); ?>');"
                class="bg-cover xl:h-[621px] lg:h-[546px] 2xl:w-[1084px] xl:w-[1040px] lg:w-[942px] md:w-[597px] md:h-[347px] w-[327px] overflow-hidden">
                <img src="<?php echo get_field("score_card"); ?>" class="w-full h-full rounded-2xl" />
            </div>
        </div>
