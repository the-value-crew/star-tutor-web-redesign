    ...
    <div
      id="scoreCardSection"
      class=" xl:h-[621px] lg:h-[546px] md:h-[347px] mt-[90px] mb-[120px] w-full m-auto relative md:mt-[120px] hidden md:block"
    >
      <div
        class="bg-heroSectionGradient h-[50%] w-screen absolute top-[-90px] md:top-[-120px]"
      ></div>
      <div class="isActiveImageLeft" id="scoreCardDup">
        ...
        >
          <img
            src="<?php echo get_field("score_card"); ?>"
...
src="<?php echo get_field("score_card"); ?>"
    ...
    <div
        class="bg-heroSectionGradient h-[25%] absolute top-[-55px] -z-10 w-screen"
      ></div>
    ...
    >
      ...
      <div>
        <div
          class="w-[328px] h-[190px]"
        >
          <img
            src="<?php echo get_field("score_card"); ?>"
            class="w-full h-full shadow-lg rounded-2xl"
          />
        </div>
      </div>
      <div>
